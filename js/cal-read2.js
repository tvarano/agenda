var clientId = '995826400847-sufcgpni5rkdkjh37pbdbfds6k3kq2pe.apps.googleusercontent.com'; //choose web app client Id, redirect URI and Javascript origin set to http://localhost
var apiKey = 'AIzaSyDPr79ukYI2PG1febUGtwC1Z8KYAjrrNmA'; //choose public apiKey, any IP allowed (leave blank the allowed IP boxes in Google Dev Console)
var userEmail = "varanoth@pascack.org"; //your calendar Id
var userTimeZone = "New York"; //example "Rome" "Los_Angeles" ecc...
var maxRows = 10; //events to shown
var calName = "calName"; //name of calendar (write what you want, doesn't matter)
